...
public class Main {
	...
	//public static void main(String[] args) {
		//Dog d = new Dog("Saurabh", 20 , "Bhusiya");
		//d.display();
	...
	//public static void main(String[] args) {
        ...
        //System.out.println("Perimeter (Circumference): " + c.getPerimeter());
	...
	// Task-4
	//public static void main(String[] args) {
      //  Employee emp = new Employee("Kathmandu, Nepal", "IT");
